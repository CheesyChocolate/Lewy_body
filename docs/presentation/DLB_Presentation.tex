...
\begin{frame}{The Diagnostic Problem}
    \begin{columns}
        ...
        \begin{column}{0.43\textwidth}
            \begin{center}
                % Outsourced placeholder — replace with DLB pathology / alpha-synuclein image
...
\begin{frame}{The Input: 664 Proteins}
    \begin{columns}
        ...
        \begin{column}{0.43\textwidth}
            \begin{center}
                % Outsourced placeholder — replace with Olink PEA technology diagram
                \includegraphics[width=0.95\textwidth]{figs/olink_pea.jpg}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
